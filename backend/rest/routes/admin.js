...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* ---------------------------------------------------------
       API ROUTING
       (ToknNews REST API at port 5599)
    --------------------------------------------------------- */

    const API_BASE = "http://localhost:5599";
    ...
    /* =========================================================
       ANALYTICS TAB — RENDER ALL CHARTS
    ========================================================= */
    ...
    async function loadClusterRadar() {
        ...
        const values = Object.values(rsp);
